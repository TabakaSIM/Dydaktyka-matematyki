...
\begin{document}
	...
	\Odp{
		\includegraphics[width=0.6\linewidth]{tales_proof.jpeg}
	...
	\Odp{
		\includegraphics[width=0.45\linewidth]{trj_proof_1.jpeg}
	...
	\Odp{
		...
		Dorysowywuje odcinek $EF$ równoległy do $BC$ (odwrotne tw. Talesa)
	...
	\Odp{
		Rozważając kat $\alpha$ ostry, otrzymujemy zwykły trójkąt prostokątny (gdzie odcięta jest przyprostokątną przeciwległą, rzędna jest przyprostokątną przyległa, a promień jest przeciwprostokątną).
	}
